...
/**
 Error code specific to HwKeychain that can be returned in NSError objects.
 For codes returned by the operating system, refer to SecBase.h for your
 platform.
 */
typedef NS_ENUM(OSStatus, HwKeychainErrorCode) {
	/** Some of the arguments were invalid. */
	HwKeychainErrorBadArguments = -1001,
};

/** HwKeychain error domain */
extern NSString *const kHwKeychainErrorDomain;

/** Account name. */
extern NSString *const kHwKeychainAccountKey;
 ...
 */
extern NSString *const kHwKeychainCreatedAtKey;

/** Item class. */
extern NSString *const kHwKeychainClassKey;

/** Item description. */
extern NSString *const kHwKeychainDescriptionKey;

/** Item label. */
extern NSString *const kHwKeychainLabelKey;

/** Time the item was last modified.

 The value will be a string.
 */
extern NSString *const kHwKeychainLastModifiedKey;

/** Where the item was created. */
extern NSString *const kHwKeychainWhereKey;
...
/**
 ...
 See the `NSString` constants declared in HwKeychain.h for a list of keys that can be used when accessing the
