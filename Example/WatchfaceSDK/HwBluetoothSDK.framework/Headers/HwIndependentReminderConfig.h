...
#import "HwIndependentReminderEventConfigu.h"
#import "HwBluetoothCenter+StatusSetting.h"

NS_ASSUME_NONNULL_BEGIN

@interface HwIndependentReminderConfig : NSObject

@property(nonatomic, assign) HwIndependentReminderEventType type;
