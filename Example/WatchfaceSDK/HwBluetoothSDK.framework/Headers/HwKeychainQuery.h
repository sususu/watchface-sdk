...
typedef NS_ENUM(NSUInteger, HwKeychainQuerySynchronizationMode) {
	HwKeychainQuerySynchronizationModeAny,
	HwKeychainQuerySynchronizationModeNo,
	HwKeychainQuerySynchronizationModeYes
};
#endif
 ...
 */
@interface HwKeychainQuery : NSObject
...
@property (nonatomic) HwKeychainQuerySynchronizationMode synchronizationMode;
#endif
